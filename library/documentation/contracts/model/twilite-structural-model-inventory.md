...
- The authored interface frame is the graph-backed node's shape in a workspace. Its border, hit area, minimap window, edge apertures, and semantic-zoom measurement share those bounds.
